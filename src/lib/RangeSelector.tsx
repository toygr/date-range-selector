        ...
        if (ref_wrapper.current && ref_axis_wrapper.current) {
            ...
            d3.select(ref_wrapper.current as Element)
                ...
                .on("mousemove", function (event) {
                    ...
                    if (hoverRange) {
                        // console.log("Down IN")
                        setRanges((v: RangeDateType[]) => v.filter(r => r !== hoverRange))
                    ...
                    if (ref_editingRange.current) {
                        ...
                        ref_save.current = true
                        setRanges((v: RangeDateType[]) => [...v, vv])
        ...
        <>
            ...
            <div className="w-full">
                <div className="w-fit flex items-center border border-black mb-3">
                    ...
                    <button disabled={false} className={`p-1 ${zoomEnabled ? "" : "bg-[#3b2dff] text-white"} hover:scale-[1.2] disabled:cursor-not-allowed disabled:opacity-30`} onClick={disableZoom}>
